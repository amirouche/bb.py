...
"""
        ...
        print(
            f"   ✓ Normalized code length: {len(loaded_data['normalized_code'])} chars"
        )
        ...
        # Verify mapping data
        if (
            loaded_mapping[0] == test_docstring
            and loaded_mapping[1] == test_name_mapping
            and loaded_mapping[2] == test_alias_mapping
            and loaded_mapping[3] == test_comment
        ):
...
def test_migration_simulation():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Add a mapping
        mapping_save_v1(
            test_hash, "eng", "Test function", {"_bb_v_0": "test"}, {}, "test mapping"
        )
