...
def test_real_migration():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        mapping_save_v1(func1_hash, "eng", "Add two numbers", 
                       {"_bb_v_0": "add", "_bb_v_1": "x", "_bb_v_2": "y"}, {}, "test mapping 1")
        ...
        mapping_save_v1(func2_hash, "eng", "Subtract two numbers",
                       {"_bb_v_0": "subtract", "_bb_v_1": "a", "_bb_v_2": "b"}, {}, "test mapping 2")
        
        print(f"   ✓ Created 2 functions in file-based storage")
        ...
        try:
            ...
            try:
                ...
                if (ast.dump(tree1_file) == ast.dump(tree1_sqlite) and
                    ast.dump(tree2_file) == ast.dump(tree2_sqlite) and
                    doc1 == doc1_sqlite and doc2 == doc2_sqlite):
